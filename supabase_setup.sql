...
('speakers_desc', 'We are honored to present our distinguished Keynote Speakers of AECTSD 2025, invited to deliver a featured address at a conference. Their presentations set the tone for the event, aligning with its central theme. The industry leaders and renowned academics, will share their insights on cutting-edge technologies on topics pertaining to the scope of the conference.'),
...
('hero_title', 'Welcome to AECTSD 2027'),
('hero_subtitle', 'Second IEEE International Conference On Advances in Engineering and Computing Technologies for Sustainable Development (AECTSD) 2027'),
